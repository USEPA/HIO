...
for(sector in 1:length(concrete_sector_list)){
  ...
  # Save the normalized waste treatment commodity output, in terms of $/short ton waste, to the factor_list
  ...
  # Temporary to convert short tons to kg
  totalImpacts_factor_list <- lapply(totalImpacts_factor_list, "*", (1/907.185))
  directImpacts_factor_list <- lapply(directImpacts_factor_list, "*", (1/907.185))
}
