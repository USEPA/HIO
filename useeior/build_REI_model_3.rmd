...
REI_result_list <- c("Compensation of employees//USD","Jobs//p","Taxes on production and imports, less subsidies//USD")
# Print REI LCIs only
LCI_result <- results[["LCI_f"]][rowSums(results[["LCI_f"]])>0,]
LCI_result <- LCI_result[,which(colnames(LCI_result) %in% REI_result_list)]
print(LCI_result)
