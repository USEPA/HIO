"""
Generates CDD concrete national 2018 flow-by-sector model and saves it to local cache
along with the validation log
See the notes on 'CDD_concrete_national_2018.yaml' for requirements
"""
...
method = 'CDD_concrete_national_2018'
